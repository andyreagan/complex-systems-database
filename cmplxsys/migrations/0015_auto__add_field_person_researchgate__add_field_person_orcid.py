...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.researchgate'
        db.add_column(u'cmplxsys_person', 'researchgate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.orcid'
        db.add_column(u'cmplxsys_person', 'orcid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=19, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.researchgate'
        db.delete_column(u'cmplxsys_person', 'researchgate')

        # Deleting field 'Person.orcid'
        db.delete_column(u'cmplxsys_person', 'orcid')
    ...
    models = {
        ...
        u'cmplxsys.person': {
            ...
            'image_circle': ('django.db.models.fields.files.FileField', [], {'default': "'people/circles/blank.png'", 'max_length': '100'}),
