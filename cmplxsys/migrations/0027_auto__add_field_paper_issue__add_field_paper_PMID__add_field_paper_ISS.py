...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.issue'
        db.add_column(u'cmplxsys_paper', 'issue',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Paper.PMID'
        db.add_column(u'cmplxsys_paper', 'PMID',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Paper.ISSN'
        db.add_column(u'cmplxsys_paper', 'ISSN',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.issue'
        db.delete_column(u'cmplxsys_paper', 'issue')

        # Deleting field 'Paper.PMID'
        db.delete_column(u'cmplxsys_paper', 'PMID')

        # Deleting field 'Paper.ISSN'
        db.delete_column(u'cmplxsys_paper', 'ISSN')
