...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.affiliation0'
        db.alter_column(u'cmplxsys_person', 'affiliation0', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Person.affiliation0'
        db.alter_column(u'cmplxsys_person', 'affiliation0', self.gf('django.db.models.fields.CharField')(max_length=200))
