...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.organizer_email'
        db.alter_column(u'cmplxsys_event', 'organizer_email', self.gf('django.db.models.fields.EmailField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Event.organizer_email'
        db.alter_column(u'cmplxsys_event', 'organizer_email', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))
