...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.HTMLabstract'
        db.add_column(u'cmplxsys_paper', 'HTMLabstract',
                      self.gf('django.db.models.fields.TextField')(default='There are none.<br>'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.HTMLabstract'
        db.delete_column(u'cmplxsys_paper', 'HTMLabstract')
