...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.yearInt'
        db.add_column(u'cmplxsys_paper', 'yearInt',
                      self.gf('django.db.models.fields.IntegerField')(default=1950),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.yearInt'
        db.delete_column(u'cmplxsys_paper', 'yearInt')
    ...
    models = {
        ...
        u'cmplxsys.paper': {
            ...
            'yearInt': ('django.db.models.fields.IntegerField', [], {'default': '1950'})
        },
        u'cmplxsys.person': {
