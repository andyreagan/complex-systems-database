...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Press.imagelink'
        db.alter_column(u'cmplxsys_press', 'imagelink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Course.imagelink'
        db.alter_column(u'cmplxsys_course', 'imagelink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Paper.googlescholarlink'
        db.alter_column(u'cmplxsys_paper', 'googlescholarlink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Paper.preprintlink'
        db.alter_column(u'cmplxsys_paper', 'preprintlink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Paper.supplementarylink'
        db.alter_column(u'cmplxsys_paper', 'supplementarylink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Paper.arxivlink'
        db.alter_column(u'cmplxsys_paper', 'arxivlink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Paper.onlineappendices'
        db.alter_column(u'cmplxsys_paper', 'onlineappendices', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Paper.journalpagelink'
        db.alter_column(u'cmplxsys_paper', 'journalpagelink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Press.imagelink'
        db.alter_column(u'cmplxsys_press', 'imagelink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Course.imagelink'
        db.alter_column(u'cmplxsys_course', 'imagelink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.googlescholarlink'
        db.alter_column(u'cmplxsys_paper', 'googlescholarlink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.preprintlink'
        db.alter_column(u'cmplxsys_paper', 'preprintlink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.supplementarylink'
        db.alter_column(u'cmplxsys_paper', 'supplementarylink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.arxivlink'
        db.alter_column(u'cmplxsys_paper', 'arxivlink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.onlineappendices'
        db.alter_column(u'cmplxsys_paper', 'onlineappendices', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.journalpagelink'
        db.alter_column(u'cmplxsys_paper', 'journalpagelink', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
