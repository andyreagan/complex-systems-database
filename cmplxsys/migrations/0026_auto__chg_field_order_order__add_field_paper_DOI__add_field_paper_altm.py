...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.order'
        db.alter_column(u'cmplxsys_order', 'order', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding field 'Paper.DOI'
        db.add_column(u'cmplxsys_paper', 'DOI',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Paper.altmetric_id'
        db.add_column(u'cmplxsys_paper', 'altmetric_id',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.order'
        db.alter_column(u'cmplxsys_order', 'order', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'Paper.DOI'
        db.delete_column(u'cmplxsys_paper', 'DOI')

        # Deleting field 'Paper.altmetric_id'
        db.delete_column(u'cmplxsys_paper', 'altmetric_id')
