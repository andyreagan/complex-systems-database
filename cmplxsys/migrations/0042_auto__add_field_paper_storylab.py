...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.storylab'
        db.add_column(u'cmplxsys_paper', 'storylab',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.storylab'
        db.delete_column(u'cmplxsys_paper', 'storylab')
    ...
    models = {
        ...
        u'cmplxsys.paper': {
            ...
            'storylab': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
