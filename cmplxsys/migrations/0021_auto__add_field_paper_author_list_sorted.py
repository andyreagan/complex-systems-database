...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.author_list_sorted'
        db.add_column(u'cmplxsys_paper', 'author_list_sorted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.author_list_sorted'
        db.delete_column(u'cmplxsys_paper', 'author_list_sorted')
