...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.sort_date'
        db.add_column(u'cmplxsys_paper', 'sort_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Person.collaborator'
        db.add_column(u'cmplxsys_person', 'collaborator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Person.alumni'
        db.add_column(u'cmplxsys_person', 'alumni',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.sort_date'
        db.delete_column(u'cmplxsys_paper', 'sort_date')

        # Deleting field 'Person.collaborator'
        db.delete_column(u'cmplxsys_person', 'collaborator')

        # Deleting field 'Person.alumni'
        db.delete_column(u'cmplxsys_person', 'alumni')
