...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cmplxsys_project', 'image',
                      self.gf('django.db.models.fields.files.FileField')(default='project/blank.png', max_length=100),
                      keep_default=False)

        # Adding field 'Paper.image'
        db.add_column(u'cmplxsys_paper', 'image',
                      self.gf('django.db.models.fields.files.FileField')(default='paper/blank.png', max_length=100),
                      keep_default=False)

        # Adding field 'Person.image'
        db.add_column(u'cmplxsys_person', 'image',
                      self.gf('django.db.models.fields.files.FileField')(default='person/blank.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.image'
        db.delete_column(u'cmplxsys_project', 'image')

        # Deleting field 'Paper.image'
        db.delete_column(u'cmplxsys_paper', 'image')

        # Deleting field 'Person.image'
        db.delete_column(u'cmplxsys_person', 'image')
