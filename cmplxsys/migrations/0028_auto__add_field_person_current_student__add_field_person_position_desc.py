...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.current_student'
        db.add_column(u'cmplxsys_person', 'current_student',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Person.position_desc'
        db.add_column(u'cmplxsys_person', 'position_desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.current_student'
        db.delete_column(u'cmplxsys_person', 'current_student')

        # Deleting field 'Person.position_desc'
        db.delete_column(u'cmplxsys_person', 'position_desc')
