...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Press.favorite'
        db.alter_column(u'cmplxsys_press', 'favorite', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Press.favorite'
        db.alter_column(u'cmplxsys_press', 'favorite', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
