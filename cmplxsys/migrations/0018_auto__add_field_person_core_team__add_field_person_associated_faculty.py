...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.core_team'
        db.add_column(u'cmplxsys_person', 'core_team',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Person.associated_faculty'
        db.add_column(u'cmplxsys_person', 'associated_faculty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.core_team'
        db.delete_column(u'cmplxsys_person', 'core_team')

        # Deleting field 'Person.associated_faculty'
        db.delete_column(u'cmplxsys_person', 'associated_faculty')
