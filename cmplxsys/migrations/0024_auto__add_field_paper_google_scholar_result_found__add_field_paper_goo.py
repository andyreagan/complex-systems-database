...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.google_scholar_result_found'
        db.add_column(u'cmplxsys_paper', 'google_scholar_result_found',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Paper.google_scholar_most_recent_date'
        db.add_column(u'cmplxsys_paper', 'google_scholar_most_recent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Paper.google_scholar_raw_result'
        db.add_column(u'cmplxsys_paper', 'google_scholar_raw_result',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.google_scholar_result_found'
        db.delete_column(u'cmplxsys_paper', 'google_scholar_result_found')

        # Deleting field 'Paper.google_scholar_most_recent_date'
        db.delete_column(u'cmplxsys_paper', 'google_scholar_most_recent_date')

        # Deleting field 'Paper.google_scholar_raw_result'
        db.delete_column(u'cmplxsys_paper', 'google_scholar_raw_result')
