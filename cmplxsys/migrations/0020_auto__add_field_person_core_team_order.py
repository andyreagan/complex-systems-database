...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.core_team_order'
        db.add_column(u'cmplxsys_person', 'core_team_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.core_team_order'
        db.delete_column(u'cmplxsys_person', 'core_team_order')
