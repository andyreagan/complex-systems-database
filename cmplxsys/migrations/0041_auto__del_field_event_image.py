...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cmplxsys_event', 'image')


    def backwards(self, orm):
        # Adding field 'Event.image'
        db.add_column(u'cmplxsys_event', 'image',
                      self.gf('django.db.models.fields.files.FileField')(default='events/blank.png', max_length=100),
                      keep_default=False)
