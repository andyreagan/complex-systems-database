...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.arxiv'
        db.add_column(u'cmplxsys_person', 'arxiv',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.image_circle'
        db.add_column(u'cmplxsys_person', 'image_circle',
                      self.gf('django.db.models.fields.files.FileField')(default='person/blank.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.arxiv'
        db.delete_column(u'cmplxsys_person', 'arxiv')

        # Deleting field 'Person.image_circle'
        db.delete_column(u'cmplxsys_person', 'image_circle')
    ...
    models = {
        ...
        u'cmplxsys.person': {
            ...
            'image_circle': ('django.db.models.fields.files.FileField', [], {'default': "'person/blank.png'", 'max_length': '100'}),
